  ...
  return (
    ...
    <section className='max-w-6xl mx-auto flex justify-center items-center flex-col'>
      ...
      <div className='w-full md:w-[50%] m-auto mt-6 px-3'>
        <form>
          <input disabled={!changeDetail} onChange={onChange} className='mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out ' type="text" id="name" value={name}></input>
          ...
          <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6 items-center'> 
            <p className='flex items-center mb-6 '>Do You Want to change your name?&nbsp;<span className={`text-red-600 cursor-pointer hover:text-red-700 transition duration-200 ease-in-out ${changeDetail && "bg-red-200 focus:bg-red-200"}`} onClick={() => { changeDetail && onSubmit(); setChangeDetail((prevState) => !prevState)}}>{changeDetail ? "Apply Changes":"Edit"}</span></p>
